...
SECRET_KEY = 'django-insecure-ps#@(ot1u96bqh4-@w5=nke0-cpz5au2ol%)hfue6$ftm^jwza'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Where static files are located during development
